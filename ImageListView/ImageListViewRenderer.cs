    ...
    public class ImageListViewRenderer : IDisposable
    {
        ...
        private class ItemDrawOrderComparer : IComparer<DrawItemParams>
        {
            ...
            public int Compare(DrawItemParams param1, DrawItemParams param2)
            {
                ...
                switch (mDrawOrder)
                {
                    case ItemDrawOrder.ItemIndex:
                        return CompareByIndex(param1, param2);
                    case ItemDrawOrder.ZOrder:
                        return CompareByZOrder(param1, param2);
                    case ItemDrawOrder.NormalSelectedHovered:
                        ...
                        if (comparison != 0) return comparison;
                        break;
                    case ItemDrawOrder.NormalHoveredSelected:
                        comparison = -CompareBySelected(param1, param2);
                        if (comparison != 0) return comparison;
                        comparison = -CompareByHovered(param1, param2);
                        if (comparison != 0) return comparison;
                        ...
                        if (comparison != 0) return comparison;
                        break;
                    case ItemDrawOrder.SelectedNormalHovered:
                        comparison = -CompareByHovered(param1, param2);
                        if (comparison != 0) return comparison;
                        comparison = -CompareByNormal(param1, param2);
                        if (comparison != 0) return comparison;
                        ...
                        if (comparison != 0) return comparison;
                        break;
                    case ItemDrawOrder.SelectedHoveredNormal:
                        comparison = -CompareByNormal(param1, param2);
                        if (comparison != 0) return comparison;
                        comparison = -CompareByHovered(param1, param2);
                        if (comparison != 0) return comparison;
                        ...
                        if (comparison != 0) return comparison;
                        break;
                    case ItemDrawOrder.HoveredNormalSelected:
                        comparison = -CompareBySelected(param1, param2);
                        if (comparison != 0) return comparison;
                        comparison = -CompareByNormal(param1, param2);
                        if (comparison != 0) return comparison;
                        ...
                        if (comparison != 0) return comparison;
                        break;
                    case ItemDrawOrder.HoveredSelectedNormal:
                        comparison = -CompareByNormal(param1, param2);
                        if (comparison != 0) return comparison;
                        comparison = -CompareBySelected(param1, param2);
                        if (comparison != 0) return comparison;
            ...
            private int CompareByTextIndex(ImageListViewItem item1, ImageListViewItem item2)
            {
                if (int.TryParse(item1.Text, out int a) && int.TryParse(item2.Text, out int b))
                {
                    if (a < b)
                        return -1;
                    else if (a > b)
        ...
        private void RenderPane(Graphics g)
        {
            ...
            Rectangle bounds = ImageListView.layoutManager.ClientArea;
            bounds.Width = ImageListView.PaneWidth;
        ...
        internal bool RecreateBuffer(Graphics graphics)
        {
            ...
            int width = Math.Max(ImageListView.Width, 1);
            int height = Math.Max(ImageListView.Height, 1);
        ...
        public virtual void DrawItem(Graphics g, ImageListViewItem item, ItemState state, Rectangle bounds)
        {
            ...
            if (ImageListView.Enabled)
            {
                using (Brush bItemBack = new SolidBrush(alternate && ImageListView.View == View.Details ?
                    ImageListView.Colors.AlternateBackColor : item.BackColor == Color.Empty ? ImageListView.Colors.BackColor : item.BackColor))
                {
            ...
            {
                using (Brush bItemBack = new SolidBrush(item.BackColor == Color.Empty ? ImageListView.Colors.DisabledBackColor : item.BackColor))
                {
                    g.FillRectangle(bItemBack, bounds);
                }
            }
        ...
        public virtual void DrawGroupHeader(Graphics g, string name, Rectangle bounds)
        {
            ...
            if (bounds.Width > 4)
            {
                using (StringFormat sf = new StringFormat())
                {
                    ...
                    {
                        g.DrawString(name, (ImageListView.GroupHeaderFont ?? ImageListView.Font), bText, bounds, sf);
                    }
                }
            }
        }
        ...
        public virtual void DrawColumnHeader(Graphics g, ImageListViewColumnHeader column, ColumnState state, Rectangle bounds)
        {
            ...
            if (bounds.Width > 4)
            {
                using (StringFormat sf = new StringFormat())
                {
                    ...
                    using (SolidBrush bText = new SolidBrush(ImageListView.Colors.ColumnHeaderForeColor))
                    {
                        g.DrawString(column.Text, (ImageListView.ColumnHeaderFont ?? ImageListView.Font), bText, bounds, sf);
                    }
                }
            }
        }

...
{    /// <summary>
    ...
    public partial class ImageListView : Control, IComponent
    {
        ...
        private ImageListViewSelectedItemCollection mSelectedItems;
        private ImageListViewCheckedItemCollection mCheckedItems;
        ...
        public ImageListViewItemAdaptor defaultAdaptor;
                ...
                if (mCacheMode != value)
                {
                    ...
                    if (mCacheMode == CacheMode.Continuous)
                    {
                        ...
                        if (thumbnailCache != null)
                        {
                            ...
                            ImageListViewCacheThumbnail.DiskCache.Size = 0;
                        }
                        // Rebuild the cache
                        ClearThumbnailCache();
                    }
        ...
        //    get
        //    {
        //        return ImageListViewCacheThumbnail.DiskCache.DirectoryName;
        //    }
        //    set
        //    {
        //        ImageListViewCacheThumbnail.DiskCache.DirectoryName = value;
        //    }
        //}
        ///// <summary>
        ...
        //        if (thumbnailCache != null)
        //            return ImageListViewCacheThumbnail.DiskCache.Size / 1024 / 1024;
        //        else
        //            return 0;
        //    }
        //    set
        //    {
        //        if (thumbnailCache != null)
        //            ImageListViewCacheThumbnail.DiskCache.Size = value * 1024 * 1024;
        //    }
        //}
        /// <summary>
        ...
        internal void Refresh(bool force = false, bool lazy = false)
        {
            if (force)
                base.Refresh();
            else if (lazy)
        ...
        internal void OnMouseMoveUsed(MouseEventArgs e)
        {
            OnMouseMove(e);
        }
        /// <summary>
        ...
        internal void OnMouseWheelUsed(MouseEventArgs e)
        {
            OnMouseWheel(e);
        }
        /// <summary>
        ...
        public void KeyDownUsed(KeyEventArgs e)
        {
            OnKeyDown(e);
        }
        ...
        public void KeyUpUsed(KeyEventArgs e)
        {
            OnKeyUp(e);
        }
        /// <summary>
        ...
        internal virtual void OnDropFiles(DropFileEventArgs e)
        {
            ...
            //// Add items
            //bool first = true;
            //foreach (string text in e.FileNames.Keys)
            //{
            //    string filename = e.FileNames[text];
            //    ImageListViewItem item = new ImageListViewItem(filename) { Text = text, Tag = text };
        ...
        internal virtual void OnColumnWidthChanged(ColumnEventArgs e)
        {
        ...
        internal virtual void OnColumnClick(ColumnClickEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A ColumnClickEventArgs that contains event data.</param>
        internal virtual void OnColumnHover(ColumnHoverEventArgs e)
        {
        ...
        internal virtual void OnItemClick(ItemClickEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A ItemClickEventArgs that contains event data.</param>
        internal virtual void OnItemHover(ItemHoverEventArgs e)
        {
        ...
        /// </summary>
        /// <param name="e">A ItemClickEventArgs that contains event data.</param>
        internal virtual void OnItemDoubleClick(ItemClickEventArgs e)
        {
        ...
        internal virtual void OnPaneResized(PaneResizedEventArgs e)
        {
        ...
        internal virtual void OnPaneResizing(PaneResizingEventArgs e)
        {
        ...
        internal virtual void OnItemCollectionChanged(ItemCollectionChangedEventArgs e)
        {
